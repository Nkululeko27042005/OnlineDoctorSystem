...
namespace DoctorSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    if (UserManager.IsInRole(user.Id, "LabTechnician"))
                    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, UserRole = model.UserRole, RegisteredDate = DateTime.Now};
                ...
                if (result.Succeeded)
                {
                    ...
                    { 
                        var doctor = new Doctor { FirstName = model.FirstName, LastName = model.LastName, FullName = model.FirstName + " " + model.LastName, EmailAddress = model.Email, Specialization = "General Practitioner", Education = "PHD in Medicine",ApplicationUserId = user.Id };
                    ...
                    else if (model.UserRole == "LabTechnician")
                    {
                        await UserManager.AddToRoleAsync(user.Id, user.UserRole);
                        return RedirectToAction("Login", "Account");
                    }
